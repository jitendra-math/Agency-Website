...
export default function TermsOfServiceContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-gradient-to-b from-neutral-50 via-white to-neutral-100/50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-900/50 transition-colors duration-500">
      ...
      <div className="space-y-8 text-sm sm:text-base">
        ...
        <div className="mt-10 p-5 bg-white/50 dark:bg-neutral-900/40 rounded-xl border border-neutral-200/60 dark:border-neutral-800/60 backdrop-blur-sm">
      ...
      <div className="mt-12 pt-6 border-t border-neutral-200/60 dark:border-neutral-800/60 text-center text-xs text-neutral-500 dark:text-neutral-500">
