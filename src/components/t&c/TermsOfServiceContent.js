...
export default function TermsOfServiceContent() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-[#fafafa] dark:bg-[#050505] transition-colors duration-500">
      {/* Header – only brand name, no contact */}
      ...
      <div className="space-y-8 text-sm sm:text-base">
        ...
        <div className="mt-10 p-5 bg-neutral-50 dark:bg-neutral-900/30 rounded-xl border border-neutral-200 dark:border-neutral-800">
