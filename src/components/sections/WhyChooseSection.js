    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        ...
        >
          ...
          <p
            className="mt-4 text-[14px] sm:text-base leading-relaxed text-neutral-600 dark:text-neutral-400 font-medium"
          >
          ...
          {principles.map((principle, idx) => (
            ...
            >
              <div className="relative flex-shrink-0 md:w-32">
                <span
                  className="text-7xl sm:text-8xl md:text-9xl font-black tracking-tighter text-neutral-900/5 dark:text-white/5 select-none"
                >
                  {principle.number}
                </span>
              </div>
              ...
              <div className="flex-1">
                <h3
                  className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-neutral-900 dark:text-white mb-4"
                >
                  {principle.title}
                </h3>
                <p
                  className="text-base sm:text-lg leading-relaxed text-neutral-600 dark:text-neutral-400 max-w-2xl"
                >
        ...
        >
          <div
            className="relative overflow-hidden rounded-3xl bg-white/40 dark:bg-white/[0.02] ring-1 ring-inset ring-black/5 dark:ring-white/10 backdrop-blur-2xl p-8 sm:p-12 md:p-16 text-center"
          >
            ...
            <h3
              className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-neutral-900 dark:text-white mb-6"
            >
              Our Philosophy
            </h3>

            <p
              className="text-base sm:text-lg md:text-xl leading-relaxed text-neutral-600 dark:text-neutral-400 max-w-3xl mx-auto"
            >
