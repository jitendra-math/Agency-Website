  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10 flex items-center justify-center pointer-events-none overflow-hidden">
        ...
        <motion.div
          ...
          className="
            ...
            blur-[80px] sm:blur-[120px]   /* reduced blur */
        ...
        <motion.div
          ...
          className="
            ...
            blur-[80px] sm:blur-[110px]   /* reduced blur */
            mix-blend-multiply dark:mix-blend-screen
          "
        />
      </div>
      ...
      <div className="mx-auto max-w-5xl relative z-10 flex flex-col items-center">
        ...
        {/* ===================================== */}
        {/* FLOATING GLASS CHIPS – Optimized */}
        {/* ===================================== */}
        <motion.div
          variants={fadeUpVariants}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true, margin: "-100px" }}
          transition={{ delay: 0.2 }} // add a small delay after header
        ...
        >
          {techStack.map((tech, index) => (
            <motion.div
              ...
              whileInView="show"
              viewport={{ once: true }}
              transition={{ delay: 0.2 + index * 0.05 }} // delay only, duration from variant
              className="
              ...
              "
            >
              {/* Inner subtle glow on hover – cheap CSS transition */}
              ...
              {/* Magical glowing bottom line – CSS transform, cheap */}
