    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-[20%] left-[-5%] sm:top-[30%] sm:left-[10%] w-[70vw] h-[70vw] sm:w-[500px] sm:h-[500px] rounded-full bg-blue-200/30 dark:bg-blue-900/15 blur-[100px] sm:blur-[140px] mix-blend-multiply dark:mix-blend-screen"
        />
        <motion.div
          animate={{
            x: [0, 20, 0],
          ...
          className="absolute bottom-[10%] right-[-5%] sm:bottom-[20%] sm:right-[10%] w-[80vw] h-[80vw] sm:w-[550px] sm:h-[550px] rounded-full bg-cyan-200/25 dark:bg-cyan-800/12 blur-[100px] sm:blur-[140px] mix-blend-multiply dark:mix-blend-screen"
        />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="space-y-6 sm:space-y-8">
          {standards.map((standard, index) => (
            ...
            >
              <p
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium tracking-tight text-neutral-700 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white transition-colors duration-500 leading-[1.2]"
              >
                {standard}
              </p>
