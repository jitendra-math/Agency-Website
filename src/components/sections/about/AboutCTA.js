// src/components/sections/about/AboutCTA.js
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-4xl">
        ...
        <motion.div
          ...
          className="relative rounded-3xl sm:rounded-[2.5rem] bg-white/40 dark:bg-white/[0.02] ring-1 ring-inset ring-black/5 dark:ring-white/10 backdrop-blur-2xl p-8 sm:p-12 md:p-16 text-center overflow-hidden"
        >
          {/* Inner Ambient Glow */}
          ...
          >
            If you're ready to create a digital presence designed for long-term growth, we'd love to start the conversation.
          </motion.p>
          ...
          >
            ...
            <Link href="/contact" className="group relative">
              <button
                className="relative w-full sm:w-auto px-8 py-3.5 sm:px-10 sm:py-4 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-base sm:text-lg font-semibold shadow-md shadow-blue-500/20 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/30 active:scale-95 overflow-hidden"
              >
            ...
            <Link href="/projects" className="group">
              <button
                className="w-full sm:w-auto px-8 py-3.5 sm:px-10 sm:py-4 rounded-full bg-white/60 dark:bg-white/5 backdrop-blur-md border border-white/40 dark:border-white/10 text-neutral-800 dark:text-white text-base sm:text-lg font-medium transition-all duration-300 hover:bg-white/80 dark:hover:bg-white/10 hover:scale-105 hover:shadow-lg active:scale-95"
              >
                View Our Work
              </button>
            </Link>
          ...
          <motion.div
            ...
            className="mt-8"
          >
            <p className="text-xs text-neutral-500 dark:text-neutral-500 max-w-md mx-auto">
              No pressure. Just a conversation about your goals and how we might help.
            </p>
          </motion.div>
        </motion.div>
      </div>
