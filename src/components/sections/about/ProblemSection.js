    ...
    >
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        <motion.div
          ...
          className="absolute top-[10%] left-[-5%] sm:top-[20%] sm:left-[5%] w-[80vw] h-[80vw] sm:w-[550px] sm:h-[550px] rounded-full bg-indigo-200/25 dark:bg-indigo-800/15 blur-[100px] sm:blur-[130px] mix-blend-multiply dark:mix-blend-screen"
        />
        <motion.div
          animate={{
            x: [0, 30, 0],
          ...
          className="absolute bottom-[15%] right-[-5%] sm:bottom-[25%] sm:right-[10%] w-[70vw] h-[70vw] sm:w-[480px] sm:h-[480px] rounded-full bg-cyan-200/30 dark:bg-cyan-800/12 blur-[100px] sm:blur-[130px] mix-blend-multiply dark:mix-blend-screen"
        />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          >
            <h2
              className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight text-neutral-900 dark:text-white leading-[1.2]"
            >
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            className="lg:pl-8 border-l-0 lg:border-l border-neutral-200/60 dark:border-neutral-800/60"
          >
            <div className="pl-0 lg:pl-8">
              ...
              <p
                className="text-xl sm:text-2xl md:text-3xl font-semibold tracking-tight text-neutral-900 dark:text-white leading-[1.3]"
              >
