// src/components/sections/PricingPlans.js
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        >
          ...
          <p className="mt-4 text-[14px] sm:text-base leading-relaxed text-neutral-600 dark:text-neutral-400 font-medium max-w-2xl mx-auto">
