...
export default function FAQHero() {
  ...
  const trustPills = ["Transparent Process", "No Hidden Costs", "Direct Communication"];
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto text-center">
        ...
        >
          Before starting a project, it helps to understand how we work, what to expect, and how we approach building digital experiences designed for long-term growth.
        </motion.p>
