// src/components/work/WhyResultsMatter.jsx

"use client";

import { motion } from "framer-motion";
import { ShieldCheck, Search, TrendingUp, BadgeCheck } from "lucide-react";
...
const resultsBlocks = [
  {
    ...
    title: "Trust",
    description:
      "Professional experiences help customers feel confident choosing your business.",
  },
  {
    icon: Search,
    title: "Visibility",
    description:
      "Being discoverable matters when people are searching for solutions.",
  },
  {
    icon: TrendingUp,
    title: "Growth",
    description:
      "Digital foundations should support businesses for years, not weeks.",
  },
  {
    icon: BadgeCheck,
    title: "Credibility",
    description:
      "People trust brands that invest in quality experiences.",
  },
];

export default function WhyResultsMatter() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400 mt-4 max-w-2xl mx-auto leading-relaxed">
            A website should do more than simply look impressive. It should strengthen trust, communicate professionalism and help businesses create meaningful opportunities.
          </p>
        </div>

        {/* Editorial Blocks */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
          {resultsBlocks.map((item, idx) => {
