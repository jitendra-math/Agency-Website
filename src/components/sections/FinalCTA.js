        ...
        >
          ...
          >
            {["Strategy", "Design", "Development"].map((item) => (
              <span
                key={item}
                className="px-4 py-1.5 rounded-full bg-white/50 dark:bg-white/5 border border-black/10 dark:border-white/10 backdrop-blur-sm text-xs font-medium text-neutral-700 dark:text-neutral-300"
              >
                {item}
              </span>
            ))}
